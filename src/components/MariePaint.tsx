      ...
      <div className="w-full lg:w-96 flex flex-col gap-6 flex-shrink-0">
        <div className="glass-effect p-6 rounded-3xl border border-slate-700 shadow-2xl space-y-6 sticky top-6">
          ...
          <textarea
            ...
            className="w-full h-24 bg-slate-950 border border-slate-800 rounded-xl p-3 text-xs text-slate-100 outline-none focus:ring-2 focus:ring-blue-500/30 transition-all shadow-inner"
          />
