...
export const DesignExtractor: React.FC = () => {
    ...
    const [templateName, setTemplateName] = useState<string>('MARIE_DESIGN');
    ...
    const handleFileSelect = useCallback((file: File) => {
        // Strip extension from original filename to use as PSD name
        const baseName = file.name.replace(/\.[^.]+$/, '') || 'MARIE_DESIGN';
