    ...
    Array.from(files).forEach(file => {
      ...
      reader.onload = (ev) => {
        const newItem: PaintItem = {
          ...
          redoStack: [],
          mask: null,
          prompt: activeItem?.prompt || defaultPrompt || 'Ghép nối chủ thể tự nhiên nhất có thể. Giữ nguyên 100% pixel của người thật. Đổ bóng cast shadows và chỉnh ánh sáng ambiant khớp với nền.',
